...
public class UsersDaoJdbcTemplateImpl implements UsersDao {
    ...
    //language=SQL
    private final String SQL_FIND_ALL_BY_FIRST_NAME = "SELECT * FROM fix_user WHERE first_name = ?";
    //language=SQL
    ...
    public List<User> findAllByFirstName(String firstName) {
        return template.query(SQL_FIND_ALL_BY_FIRST_NAME, userRowMapper, firstName);
    }
